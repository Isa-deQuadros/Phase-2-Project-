      ...
      <div className="form">
        ...
        >
          ...
          <input
            ...
            onChange={(event) => setReleaseYearState(event.target.value)}
          />
          <input
            type="text"
            placeholder="Genre"
            value={genreState}
            onChange={(event) => setGenreState(event.target.value)}
          />
          <input
            type="text"
          ...
          <input
            ...
            alt="the name of the game"
            value={coverState}
            onChange={(event) => setCoverState(event.target.value)}
          />
          <input
            type="url"
            placeholder="Soundtrack Url"
            value={soundtrackState}
            onChange={(event) => setSoundtrackState(event.target.value)}
          />
          <input
            type="url"
            placeholder="Game Trailer Url"
            value={trailerState}
            onChange={(event) => setTrailerState(event.target.value)}
          />
          <select
            value={ratingState}
